...
class ServicesSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Service
        fields = ("id","announcement","client", "review_average", "review_count", "cost" , "creation_date", "contacted", "contacted_date", "hired", "hired_date", "review","professional_rejected", "deleted")
    def update(self, instance, validated_data):
        for attr, value in validated_data.items():
            setattr(instance, attr, value)
        instance.save()
