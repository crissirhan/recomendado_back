...
class AnnouncementSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Announcement
        fields = ("id", "visible", "title", "description", "announcement_images", "job_tags", "professional", "professional_id", "price", "publish_date", "expire_date", "location", "approved", "availability","availability_display","movility", "announcement_thumbnail")
        depth = 3
