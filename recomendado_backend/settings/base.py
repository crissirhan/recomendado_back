"""
Django settings for recomendado_backend project.
...
SECRET_KEY = 'dkfx6=uh$zr2@fc76e=pt@d@-q10%0ydom$jb-3*-p38j#n$_o'
...
WSGI_APPLICATION = 'recomendado_backend.wsgi.application'
